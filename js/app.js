...
function getFormattedTime(){var today=new Date();var y=today.getFullYear();var m=today.getMonth()+1;var d=today.getDate();var h=today.getHours();var mi=today.getMinutes();var s=today.getSeconds();return "©"+d+"-"+m+"-"+y+"•"+h+"-"+mi+"-"+s;}
...
function popupResult(result) {
  ...
  if (result.src) {
    ...
    '<a href="'+ result.src +'" id="downloadlink" class="button" download="Powered by CAKSUP'+getFormattedTime()+'">Unduh</a>' +
    '<button class="confirm button" tabindex="1">Kembali</button>';
  }
  swal({
	title: '',
    html: true,
